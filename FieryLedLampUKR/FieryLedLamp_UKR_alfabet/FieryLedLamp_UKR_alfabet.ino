...
//
// Вирішення проблем можна пошукати тут під спойлерами:
...
/*
  Скетч до проекту "Багатофункціональний RGB світильник"
  Сторінка проекту (схеми, описи): https://alexgyver.ru/GyverLamp/
  Вихідники авторської (старої) прошивки на GitHub: https://github.com/AlexGyver/GyverLamp/
  ================================================== ========================================
  Вихідники нової версії: https://community.alexgyver.ru/goto/post?id=73929
  ================================================== ========================================
  Автор ідеї та першої реалізації: AlexGyver, AlexGyver Technologies, 2019
  https://AlexGyver.ru/
*/
...
uint8_t effects_folders[MODE_AMOUNT];
#endif  //MP3_TX_PIN
