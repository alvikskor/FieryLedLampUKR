// Поточна версія / Current version : v2.95_sound_UKR 103 ефекта
...
#define EFF_WHITE_COLOR         (  0U)    // Біле світло
#define EFF_WATERCOLOR          (  1U)    // Акварель
#define EFF_POOL                (  2U)    // Басейн
#define EFF_RAINBOW_VER         (  3U)    // Веселка
#define EFF_RAINBOW             (  4U)    // Веселка 3D
#define EFF_WINE                (  5U)    // Вино
#define EFF_WHIRL               (  6U)    // Вихори полум'я
#define EFF_WHIRL_MULTI         (  7U)    // Вихори різнокольорові
#define EFF_FIRE                (  8U)    // Вогонь
#define EFF_FIRE_2012           (  9U)    // Вогонь 2012
#define EFF_FIRE_2018           ( 10U)    // Вогонь 2018
#define EFF_FIRE_2020           ( 11U)    // Вогонь 2020
#define EFF_FIRE_2021           ( 12U)    // Вогонь 2021
#define EFF_FIREFLY_TOP         ( 13U)    // Вогонь верховий
#define EFF_FIREFLY             ( 14U)    // Вогонь, що літає
#define EFF_WATERFALL           ( 15U)    // Водоспад
#define EFF_WATERFALL_4IN1      ( 16U)    // Водоспад 4в1
#define EFF_STORMY_RAIN         ( 17U)    // Гроза в банці
#define EFF_FOUNTAIN            ( 18U)    // Джерело
#define EFF_SMOKE               ( 19U)    // Дим
#define EFF_SMOKE_COLOR         ( 20U)    // Дим різнокольоровий
#define EFF_SMOKEBALLS          ( 21U)    // Димові шашки
#define EFF_DNA                 ( 22U)    // ДНК
#define EFF_SWIRL               ( 23U)    // Завиток
#define EFF_STARFALL            ( 24U)    // Завірюха
#define EFF_FLOCK               ( 25U)    // Зграя
#define EFF_FLOCK_N_PR          ( 26U)    // Зграя та хижак
#define EFF_ZEBRA               ( 27U)    // Зебра
#define EFF_SNAKES              ( 28U)    // Змійка
#define EFF_COLORS              ( 29U)    // Зміна кольору
#define EFF_LOTUS               ( 30U)    // Квітка лотоса
#define EFF_LLAND               ( 31U)    // Кипіння
#define EFF_RINGS               ( 32U)    // Кодовий замок
#define EFF_COLOR               ( 33U)    // Колір
#define EFF_SAND                ( 34U)    // Кольорові драже
#define EFF_COLOR_FRIZZLES      ( 35U)    // Кольорові кучері


#define EFF_COMET               ( 36U)    // Комета
#define EFF_COMET_COLOR         ( 37U)    // Комета однокольорова
#define EFF_COMET_TWO           ( 38U)    // Комета подвійна
#define EFF_COMET_THREE         ( 39U)    // Комета потрійна
#define EFF_SPARKLES            ( 40U)    // Конфетті
#define EFF_DROPS               ( 41U)    // Краплі на склі
#define EFF_CUBE2D              ( 42U)    // Кубик Рубика
#define EFF_SPHERES             ( 43U)    // Кулі
#define EFF_LAVA                ( 44U)    // Лава
#define EFF_LAVALAMP            ( 45U)    // Лавова лампа
#define EFF_BUTTERFLYS_LAMP     ( 46U)    // Лампа з метеликами
#define EFF_FOREST              ( 47U)    // Ліс
#define EFF_LUMENJER            ( 48U)    // Люменьєр
#define EFF_BBALLS              ( 49U)    // М'ячики
#define EFF_BALLS_BOUNCE        ( 50U)    // М'ячики без кордонів
#define EFF_MAGMA               ( 51U)    // Магма
#define EFF_MATRIX              ( 52U)    // Матриця
#define EFF_TWINKLES            ( 53U)    // Мерехтіння
#define EFF_METABALLS           ( 54U)    // Метаболз
#define EFF_BUTTERFLYS          ( 55U)    // Метелики
#define EFF_WEB_TOOLS           ( 56U)    // Мрія дизайнера
#define EFF_CHRISTMAS_TREE      ( 57U)    // Новорічна ялинка
#define EFF_OCEAN               ( 58U)    // Океан
#define EFF_PAINTS              ( 59U)    // Олійні фарби
#define EFF_COLOR_RAIN          ( 60U)    // Опади
#define EFF_OSCILLATING         ( 61U)    // Осцилятор
#define EFF_RAINBOW_STRIPE      ( 62U)    // Павич
#define EFF_PAINTBALL           ( 63U)    // Пейнтбол
#define EFF_AURORA              ( 64U)    // Північне сяйво
#define EFF_PICASSO             ( 65U)    // Пікассо
#define EFF_HOURGLASS           ( 66U)    // Пісочний годинник
#define EFF_PLASMA              ( 67U)    // Плазма
#define EFF_SPIDER              ( 68U)    // Плазмова лампа
#define EFF_BY_EFFECT           ( 69U)    // Побічний ефект


#define EFF_FLAME               ( 70U)    // Полум'я
#define EFF_POPCORN             ( 71U)    // Попкорн
#define EFF_PRISMATA            ( 72U)    // Призмата
#define EFF_ATTRACT             ( 73U)    // Притягнення
#define EFF_PULSE               ( 74U)    // Пульс
#define EFF_PULSE_WHITE         ( 75U)    // Пульс білий
#define EFF_PULSE_RAINBOW       ( 76U)    // Пульс райдужний
#define EFF_SNAKE               ( 77U)    // Райдужний змій
#define EFF_LIQUIDLAMP          ( 78U)    // Рідка лампа
#define EFF_LIQUIDLAMP_AUTO     ( 79U)    // Рідка лампа авто
#define EFF_RAIN                ( 80U)    // Різнобарвний дощ
#define EFF_RIVERS              ( 81U)    // Річки Ботсвани
#define EFF_LIGHTERS            ( 82U)    // Світлячки
#define EFF_LIGHTER_TRACES      ( 83U)    // Світлячки зі шлейфом
#define EFF_FEATHER_CANDLE      ( 84U)    // Свічка
#define EFF_SINUSOID3           ( 85U)    // Синусоїд
#define EFF_SNOW                ( 86U)    // Снігопад
#define EFF_SPECTRUM            ( 87U)    // Спектрум
#define EFF_SPIRO               ( 88U)    // Спірали
#define EFF_LEAPERS             ( 89U)    // Стрибуни
#define EFF_STROBE              ( 90U)    // Строб.Хаос.Дифузія
#define EFF_PACIFIC             ( 91U)    // Тихий океан
#define EFF_SHADOWS             ( 92U)    // Тіні
#define EFF_UKRAINE             ( 93U)    // Україна
#define EFF_FIREWORK            ( 94U)    // Феєрверк
#define EFF_FAIRY               ( 95U)    // Фея
#define EFF_WAVES               ( 96U)    // Хвилі
#define EFF_CLOUDS              ( 97U)    // Хмари
#define EFF_SIMPLE_RAIN         ( 98U)    // Хмарка в банці
#define EFF_MADNESS             ( 99U)    // Шаленство
#define EFF_NEXUS               (100U)    // Nexus
#define EFF_CLOCK               (101U)    // Годинник
#define EFF_TEXT                (102U)    // Рядок, що біжить

#define MODE_AMOUNT           (103U)          // количество режимов
...
String("0. Біле світло,1,255,1,100,0;") +
String("1. Акварель,1,255,1,100,0;") +
String("2. Басейн,99,252,1,100,1;") +
String("3. Веселка,50,252,1,100,0;") +
String("4. Веселка 3D,1,70,1,100,0;") +
String("5. Вино,200,255,40,75,0;") +
String("6. Вихори полум'я,99,252,1,100,1;") +
String("7. Вихори різнокольорові,99,252,1,100,0;") +
String("8. Вогонь,99,252,1,100,1;") +
String("9. Вогонь 2012,99,252,1,100,0;") +
String("10. Вогонь 2018,99,252,1,100,0;") +
String("11. Вогонь 2020,120,252,1,100,0;") +
String("12. Вогонь 2021,1,255,1,100,0;") +
String("13. Вогонь верховий,99,252,1,100,0;") +
String("14. Вогонь, що літає,99,252,1,100,0;") +
String("15. Водоспад,99,252,1,100,1;") +
String("16. Водоспад 4в1,99,252,1,100,0;") +
String("17. Гроза в банці,99,252,1,100,0;") +
String("18. Джерело,99,252,1,100,0;") +
String("19. Дим,99,252,1,100,1;") +
String("20. Дим різнокольоровий,99,252,1,100,0;") +
String("21. Димові шашки,1,255,1,100,0;") +
String("22. ДНК,1,255,1,100,0;") +
String("23. Завиток,100,255,1,100,1;") +
String("24. Завірюха,99,252,1,100,0;") +
String("25. Зграя,1,255,1,100,0;") +
String("26. Зграя та хижак,1,255,1,100,0;") +
String("27. Зебра,1,30,7,40,0;") +
String("28. Змійка,1,255,1,100,0;") +
String("29. Зміна кольору,1,255,1,255,0;") +
String("30. Квітка лотоса,50,240,1,100,1;") +
String("31. Кипіння,170,252,1,100,0;") +
String("32. Кодовий замок,99,252,1,100,0;") +
String("33. Колір,1,255,1,100,1;") +
String("34. Кольорові драже,99,252,1,100,0;") +
String("35. Кольорові кучері,128,128,10,90,0;") +
String("\n");
const String efList_2 = String("LIST2;") + // ======== ВТОРАЯ СТРОКА ========
String("36. Комета,99,252,1,100,0;") +
String("37. Комета однокольорова,99,252,1,100,1;") +
String("38. Комета подвійна,99,252,1,100,0;") +
String("39. Комета потрійна,99,252,1,100,0;") +
String("40. Конфетті,99,252,1,100,0;") +
String("41. Краплі на склі,1,255,1,100,1;") +
String("42. Кубик Рубика,99,252,1,100,0;") +
String("43. Кулі,1,255,1,100,0;") +
String("44. Лава,5,60,1,100,0;") +
String("45. Лавова лампа,1,255,1,100,1;") +
String("46. Лампа з метеликами,1,255,1,100,1;") +
String("47. Ліс,2,30,70,100,0;") +
String("48. Люменьєр,1,255,1,100,0;") +
String("49. М'ячики,1,255,1,100,0;") +
String("50. М'ячики без кордонів,1,255,1,100,0;") +
String("51. Магма,150,252,1,100,0;") +
String("52. Матриця,99,240,1,100,0;") +
String("53. Мерехтіння,60,252,1,100,0;") +
String("54. Метаболз,1,255,1,100,0;") +
String("55. Метелики,1,255,1,100,0;") +
String("56. Мрія дизайнера,0,255,0,100,0;") +
String("57. Новорічна ялинка,1,160,1,100,0;") +
String("58. Океан,2,15,4,30,0;") +
String("59. Олійні фарби,1,245,1,100,0;") +
String("60. Опади,99,252,0,255,1;") +
String("61. Осцилятор,99,252,1,100,0;") +
String("62. Павич,1,30,1,30,0;") +
String("63. Пейнтбол,215,252,1,100,0;") +
String("64. Північне сяйво,1,255,1,100,1;") +
String("65. Пікассо,99,252,1,100,0;") +
String("66. Пісочний годинник,15,240,1,100,1;") +
String("67. Плазма,1,30,1,100,0;") +
String("68. Плазмова лампа,1,255,1,100,0;") +
String("69. Побічний ефект,1,200,1,100,0;") +
String("\n");
const String efList_3 = String("LIST3;") + // ======== ТРЕТЬЯ СТРОКА ========
String("70. Полум'я,1,255,0,255,1;") +
String("71. Попкорн,1,255,1,100,0;") +
String("72. Призмата,1,255,1,100,0;") +
String("73. Притягнення,160,252,1,100,0;") +
String("74. Пульс,99,252,1,100,0;") +
String("75. Пульс білий,99,252,1,100,0;") +
String("76. Пульс райдужний,99,252,1,100,0;") +
String("77. Райдужний змій,99,252,100,100,0;") +
String("78. Рідка лампа,1,255,1,100,1;") +
String("79. Рідка лампа авто,1,255,1,100,0;") +
String("80. Різнобарвний дощ,99,252,1,100,1;") +
String("81. Річки Ботсвани,1,200,1,100,0;") +
String("82. Світлячки,50,252,1,100,0;") +
String("83. Світлячки зі шлейфом,99,252,1,100,0;") +
String("84. Свічка,170,255,1,99,1;") +
String("85. Синусоїд,1,255,1,100,0;") +
String("86. Снігопад,99,252,1,100,0;") +
String("87. Спектрум,1,200,1,100,0;") +
String("88. Спірали,1,255,1,100,0;") +
String("89. Стрибуни,150,252,1,100,0;") +
String("90. Строб.Хаос.Дифузія,1,150,1,100,0;") +
String("91. Тихий океан,1,255,100,100,2;") +
String("92. Тіні,1,255,1,100,0;") +
String("93. Україна,100,245,0,100,0;") +
String("94. Феєрверк,10,245,10,90,1;") +
String("95. Фея,99,252,1,100,0;") +
String("96. Хвилі,220,252,1,100,0;") +
String("97. Хмари,1,15,1,50,0;") +
String("98. Хмарка в банці,99,252,1,100,0;") +
String("99. Шаленство,1,150,1,100,0;") +
String("100. Nexus,1,255,1,100,0;") +
String("101. Годинник,1,245,1,100,1;") +
String("102. Бегущая строка,1,252,1,100,1;") +
